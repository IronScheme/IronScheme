...
isc lib\srfi\tests\and-let_.sps >> srfitest.log
isc lib\srfi\tests\compare-procedures.sps >> srfitest.log
isc lib\srfi\tests\cut.sps >> srfitest.log
isc lib\srfi\tests\eager-comprehensions.sps >> srfitest.log
isc lib\srfi\tests\intermediate-format-strings.sps >> srfitest.log
isc lib\srfi\tests\lightweight-testing.sps >> srfitest.log
isc lib\srfi\tests\lists.sps >> srfitest.log
isc lib\srfi\tests\multi-dimensional-arrays--arlib.sps >> srfitest.log
