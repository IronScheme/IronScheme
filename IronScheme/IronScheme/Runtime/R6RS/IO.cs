...
namespace IronScheme.Runtime.R6RS
{
  ...
  public class IO : Builtins
  {
    ...
    //  {
    //    tc.codec = Encoding.GetEncoding(tc.codec.WebName, new EncCB(null), new DecCB(null));
    //  }
    ...
    //  if (port is CustomTextReaderWriter)
    //  {
    //    ClosePort(((CustomTextReaderWriter)port).output);
    ...
    //{
    //  return new CustomBinaryInputStream((string)id, (Callable) read, get_pos, set_pos, close);
    //}
    ...
    //{
    //  return new CustomTextReader((string)id, (Callable)read, get_pos, set_pos, close);
    //}
    ...
    //{
    //  return new CustomBinaryOutputStream((string)id, (Callable)read, get_pos, set_pos, close);
    //}
    ...
    //{
    //  return new CustomTextWriter((string)id, (Callable)read, get_pos, set_pos, close);
    //}
    ...
    //{
    //  return new CustomBinaryInputOutputStream((string)id, (Callable)read, (Callable)write, get_pos, set_pos, close);
    //}
    ...
    //{
    //  return new CustomTextReaderWriter(id, new CustomTextReader((string)id, (Callable)read, get_pos, set_pos, close), new CustomTextWriter((string)id, (Callable)write, get_pos, set_pos, close));
    //}
