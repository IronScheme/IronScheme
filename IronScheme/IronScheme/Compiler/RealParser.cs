...
// Modified for use in IronScheme and .NET 2 and using IntX
// https://github.com/dotnet/roslyn/pull/5379/files
...
namespace IronScheme.Compiler
{
    ...
    internal static class RealParser
    {
        ...
        private abstract class FloatingPointType
        {
            ...
            public ushort NormalMantissaBits {get { return (ushort)(DenormalMantissaBits + 1); }} // we get an extra (hidden) bit for normal mantissas
            public abstract ushort ExponentBits { get; }
            public int MinBinaryExponent {get { return 1 - MaxBinaryExponent; }}
            public abstract int MaxBinaryExponent { get; }
            public int OverflowDecimalExponent {get { return (MaxBinaryExponent + 2 * NormalMantissaBits) / 3;}}
            public abstract int ExponentBias { get; }
            public ulong DenormalMantissaMask {get { return (1UL << (DenormalMantissaBits)) - 1;}}
            public ulong NormalMantissaMask {get { return (1UL << NormalMantissaBits) - 1;}}
        ...
        private class DoubleFloatingPointType : FloatingPointType
        {
            ...
            public override ushort DenormalMantissaBits {get { return 52; }}
            public override ushort ExponentBits {get { return 11; }}
            public override int MaxBinaryExponent {get { return 1023; }}
            public override int ExponentBias {get { return 1023; }}
            public override ulong Zero {get { return (ulong)BitConverter.DoubleToInt64Bits(0.0d); }}
            public override ulong Infinity { get { return (ulong)BitConverter.DoubleToInt64Bits(1.0d / 0.0d); } }
        }
        ...
        private struct DecimalFloatingPointString
        {
            ...
            public uint MantissaCount {get { return (uint)Mantissa.Length; }}
